...
_lr_productions = [
  ...
  ('if_stmt -> IF LPAREN ptr_expr RPAREN compound_stmt','if_stmt',5,'p_def_if_stmt','150050061_17V051001.py',171),
  ('if_stmt -> IF LPAREN ptr_expr RPAREN compound_stmt ELSE compound_stmt','if_stmt',7,'p_def_if_stmt','150050061_17V051001.py',172),
  ('while_stmt -> WHILE LPAREN ptr_expr RPAREN compound_stmt','while_stmt',5,'p_def_while_stmt','150050061_17V051001.py',184),
  ...
  ('ptr_expr -> ptr_expr OR ptr_and_expr','ptr_expr',3,'p_def_ptr_expr','150050061_17V051001.py',250),
  ('ptr_expr -> ptr_and_expr','ptr_expr',1,'p_def_ptr_expr','150050061_17V051001.py',251),
  ('ptr_and_expr -> ptr_and_expr AND ptr_eq_expr','ptr_and_expr',3,'p_def_ptr_and_expr','150050061_17V051001.py',260),
  ('ptr_and_expr -> ptr_eq_expr','ptr_and_expr',1,'p_def_ptr_and_expr','150050061_17V051001.py',261),
  ('ptr_eq_expr -> ptr_eq_expr EQUALS EQUALS ptr_lt_expr','ptr_eq_expr',4,'p_def_ptr_eq_expr','150050061_17V051001.py',269),
  ('ptr_eq_expr -> ptr_eq_expr NOT EQUALS ptr_lt_expr','ptr_eq_expr',4,'p_def_ptr_eq_expr','150050061_17V051001.py',270),
  ('ptr_eq_expr -> ptr_lt_expr','ptr_eq_expr',1,'p_def_ptr_eq_expr','150050061_17V051001.py',271),
  ('ptr_lt_expr -> ptr_lt_expr LT ptr_add_expr','ptr_lt_expr',3,'p_def_ptr_lt_expr','150050061_17V051001.py',283),
  ('ptr_lt_expr -> ptr_lt_expr GT ptr_add_expr','ptr_lt_expr',3,'p_def_ptr_lt_expr','150050061_17V051001.py',284),
  ('ptr_lt_expr -> ptr_lt_expr LT EQUALS ptr_add_expr','ptr_lt_expr',4,'p_def_ptr_lt_expr','150050061_17V051001.py',285),
  ('ptr_lt_expr -> ptr_lt_expr GT EQUALS ptr_add_expr','ptr_lt_expr',4,'p_def_ptr_lt_expr','150050061_17V051001.py',286),
  ('ptr_lt_expr -> ptr_add_expr','ptr_lt_expr',1,'p_def_ptr_lt_expr','150050061_17V051001.py',287),
  ('ptr_add_expr -> ptr_add_expr PLUS ptr_factor','ptr_add_expr',3,'p_def_ptr_add_expr','150050061_17V051001.py',304),
  ('ptr_add_expr -> ptr_add_expr MINUS ptr_factor','ptr_add_expr',3,'p_def_ptr_add_expr','150050061_17V051001.py',305),
  ('ptr_add_expr -> ptr_factor','ptr_add_expr',1,'p_def_ptr_add_expr','150050061_17V051001.py',306),
  ('ptr_factor -> ptr_factor STAR ptr_term','ptr_factor',3,'p_def_ptr_factor','150050061_17V051001.py',320),
  ('ptr_factor -> ptr_factor SLASH ptr_term','ptr_factor',3,'p_def_ptr_factor','150050061_17V051001.py',321),
  ('ptr_factor -> ptr_term','ptr_factor',1,'p_def_ptr_factor','150050061_17V051001.py',322),
  ('ptr_term -> MINUS ptr_term','ptr_term',2,'p_def_ptr_term','150050061_17V051001.py',335),
  ('ptr_term -> ptr_expr_base','ptr_term',1,'p_def_ptr_term','150050061_17V051001.py',336),
  ('ptr_expr_base -> ID','ptr_expr_base',1,'p_def_ptr_expr_base','150050061_17V051001.py',345),
  ('ptr_expr_base -> NUM','ptr_expr_base',1,'p_def_ptr_expr_base','150050061_17V051001.py',346),
  ('ptr_expr_base -> ptr','ptr_expr_base',1,'p_def_ptr_expr_base','150050061_17V051001.py',347),
  ('ptr_expr_base -> addr','ptr_expr_base',1,'p_def_ptr_expr_base','150050061_17V051001.py',348),
  ('ptr_expr_base -> LPAREN ptr_expr RPAREN','ptr_expr_base',3,'p_def_ptr_expr_base','150050061_17V051001.py',349),
  ('ptr -> STAR ptr','ptr',2,'p_def_ptr','150050061_17V051001.py',365),
  ('ptr -> STAR ID','ptr',2,'p_def_ptr','150050061_17V051001.py',366),
  ('ptr -> STAR addr','ptr',2,'p_def_ptr','150050061_17V051001.py',367),
  ('addr -> AND ID','addr',2,'p_def_addr','150050061_17V051001.py',376),
  ('addr -> AND ptr','addr',2,'p_def_addr','150050061_17V051001.py',377),
  ('addr -> AND addr','addr',2,'p_def_addr','150050061_17V051001.py',378),
]
